...
def get_representation_spec(representation: str, matrix_mode: str = "3x4") -> RepresentationSpec:
    ...
    uses_loss = representation not in {"centroid_bias", "no_pair_context", "pga_feature"}
    ...
    return RepresentationSpec(
        ...
        description="passive PGA feature only" if representation == "pga_feature" else representation,
    )
